...
import { useDebounce, useRecents } from "@recordscratch/lib";
...
export const MusicSearch = ({ query, onNavigate }: { query: string; onNavigate: () => void }) => {
	const { addRecent } = useRecents("SEARCH");
...
const SearchPage = () => {
	...
	return (
		<View className=" flex flex-col gap-10">
			<View className="flex flex-row items-center border-b pr-10">
