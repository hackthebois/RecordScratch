...
const TopList = ({
  ...
  const maxColumns = screenSize === 1024 ? 6 : 3;
  const numColumns = Math.min(resources.length, maxColumns);
  const top6Width =
  ...
  const renderAddButton = () => (
    <View className="flex flex-col items-center justify-center w-full gap-6">
      ...
      >
        <Text className="capitalize w-24 text-center">
                ...
                <View className="flex-row gap-4">
                  ...
                  <View className="items-start justify-center gap-3 flex-1">
                    ...
                    <Link href={"/settings"} asChild>
                      <Button variant="outline" className="gap-2 flex-row">
                        <Settings size={18} />
                        <Text>Settings</Text>
                      </Button>
                    </Link>
